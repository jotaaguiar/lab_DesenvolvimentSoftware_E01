...
const UI_STRINGS = {
  pt: {
    ...
    formMailtoOpened: 'Abrimos seu aplicativo de e-mail com a mensagem pronta. Confirme o envio por lá.',
  ...
  en: {
    ...
    formMailtoOpened: 'We opened your email app with the message ready. Please confirm the send there.',
